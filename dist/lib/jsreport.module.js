...
const component_provider_1 = require("./providers/component.provider");
let JsReportModule = JsReportModule_1 = class JsReportModule {
    ...
    static registerComponent(options) {
        return {
            module: JsReportModule_1,
            providers: [
                {
                    provide: (0, token_helper_1.getComponentOptionsToken)(options.name),
                    useValue: options,
                },
                (0, component_provider_1.getComponentProvider)(options),
            ],
            exports: [(0, token_helper_1.getComponentToken)(options.name)],
        };
    }
};
